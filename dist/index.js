...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../style.css */ \"./src/style.css\");\n/* harmony import */ var _Button__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Button */ \"./src/scripts/Button.js\");\n\n\nvar body = document.querySelector('body');\nvar header = renderElement('header', 'header', 'Rss Virtual Keyboard');\nvar main = renderElement('main', 'main');\nvar keyboardWrapper = renderElement('div', 'keyboard_wrapper');\nvar keyboard = renderElement('div', 'keyboard');\n\nfunction renderElement(element, name, content) {\n  var node = document.createElement(\"\".concat(element));\n  node.className = name;\n  node.textContent = content;\n  return node;\n}\n\nbody.prepend(header);\nheader.after(main);\nmain.append(keyboardWrapper);\nkeyboardWrapper.append(keyboard);\nvar arrLowerCase = ['`', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0', '-', '=', 'Backspace', 'Tab', 'q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p', '[', ']', '\\\\', 'Delete', 'CapsLock', 'a', 's', 'd', 'f', 'g', 'h', 'j', 'k', 'l', ';', \"'\", 'Enter', 'Shift', 'z', 'x', 'c', 'v', 'b', 'n', 'm', ',', '.', '/', 'ArrowUp', 'Shift', 'Control', 'Meta', 'Alt', ' ', 'Alt', 'ArrowLeft', 'ArrowDown', 'ArrowRight', 'Control'];\n\nvar renderButtons = function renderButtons(arr, container) {\n  arr.forEach(function (button) {\n    var element = new _Button__WEBPACK_IMPORTED_MODULE_1__.Button(button);\n    container.append(element.generateButton());\n    return container;\n  });\n};\n\nrenderButtons(arrLowerCase, keyboard); // document.onkeydown = function (event) {\n//     arrLowerCase.push(event.key)\n//     console.log(arrLowerCase)\n// }\n\n//# sourceURL=webpack://my-webpack-project/./src/scripts/index.js?");
